...
// Bài 3: Kiểm tra số chính phương – Cách 1 (vòng lặp i*i <= x)
void bai3() {
    int x;
    printf("\nNhap mot so nguyen: ");
    scanf("%d", &x);
    ...
    if (isPerfectSquare) {
        printf("%d la so chinh phuong (cach 1).\n", x);
    } else {
        printf("%d khong phai la so chinh phuong (cach 1).\n", x);
    }
}

// Bài 4: Kiểm tra số chính phương – Cách 2 (dùng sqrt)
void bai4() {
    int x;
    printf("\nNhap mot so nguyen: ");
    scanf("%d", &x);
    ...
    int can = sqrt(x);
    if (can * can == x) {
        printf("%d la so chinh phuong (cach 2).\n", x);
    } else {
        printf("%d khong phai la so chinh phuong (cach 2).\n", x);
    }
}

// Bài 5: Menu chương trình
int main() {
    int choice;
